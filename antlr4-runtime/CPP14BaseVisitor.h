...
public:
  ...
  virtual antlrcpp::Any visitRightShift(CPP14Parser::RightShiftContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitRightShiftAssign(CPP14Parser::RightShiftAssignContext *ctx) override {
    return visitChildren(ctx);
  }
