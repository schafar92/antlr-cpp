...
# 1 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
...
# 2 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp" 2
...
# 3 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp" 2
...
# 4 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp" 2
# 4 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
# 5 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
int main_quick(int argc, char **argv); int main(int argc, char **argv);
int main_resumable(int argc, char **argv) {const int ____chimes_did_disable0 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(5886294856166962317UL)) ; if (____chimes_replaying) { switch(get_next_call()) { case(0): { goto call_lbl_0; } default: { chimes_error(); } } } ; ;
# 6 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
     int a; a = (3) ;
# 7 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
     int b; b = (4) ;
# 8 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
     int c; c = (5) ;
# 9 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
# 9 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
# 9 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
...
# 9 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
# 9 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
# 10 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
...
# 11 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
         int inside; inside = (6) ;
# 12 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
        printf("hello from %d : %d\n", omp_get_thread_num(), inside);
# 13 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
     } } } leaving_omp_parallel(____chimes_call_stack_depth0, ____chimes_region_id0, 1); reenable_current_thread(____chimes_disable0); }
# 14 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
# 15 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
     call_lbl_0: checkpoint_transformed(0, ____alias_loc_id_0);
# 16 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
# 17 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
...
# 18 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
rm_stack(false, 0UL, "main", (int *)0x0, ____alias_loc_id_1, ____chimes_did_disable0, false); }
# 5 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
int main_quick(int argc, char **argv) {const int ____chimes_did_disable0 = new_stack((void *)(&main), "main", (int *)0, 2, 0, (size_t)(0UL), (size_t)(5886294856166962317UL)) ; ; ;
# 6 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
     int a; a = (3) ;
# 7 "/scratch/jmg3/chimes/src/examples/openmp/./for_parallel.cpp"
     int b; b = (4) ;
...
static int module_init() {
    init_module(5886294856166962274UL, 1, 1, 0, 2, 0, 0, 0, 0, 0, 0,
                           &____alias_loc_id_0, (unsigned)8, (unsigned)0, (unsigned)0, (5886294856166962274UL + 1UL), (5886294856166962274UL + 2UL), (5886294856166962274UL + 3UL), (5886294856166962274UL + 4UL), (5886294856166962274UL + 5UL), (5886294856166962274UL + 6UL), (5886294856166962274UL + 7UL), (5886294856166962274UL + 8UL),
                           &____alias_loc_id_1, (unsigned)1, (unsigned)0, (unsigned)0, (5886294856166962274UL + 9UL),
                             (5886294856166962274UL + 3UL), (5886294856166962274UL + 43UL),
